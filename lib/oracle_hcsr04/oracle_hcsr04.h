...
#define ORACLE_HCSR04_GPIO_TRIGGER      ORACLE_HCSR04_CONFIG_TRIGGER_PIN
#define ORACLE_HCSR04_GPIO_ECHO         ORACLE_HCSR04_CONFIG_ECHO_PIN
#define ORACLE_HCSR04_NUM_REPEATS       ORACLE_HCSR04_CONFIG_REPEAT
#define ORACLE_HCSR04_PULSE_DELAY       TRIG_PULSE_DURATION_US
#define ORACLE_HCSR04_MAX_VALUE         ORACLE_HCSR04_CONFIG_MAX_VALUE
#define ORACLE_HCSR04_MAX_DISTANCE      ORACLE_HCSR04_CONFIG_MAX_DISTANCE
#define ORACLE_HCSR04_LOOP_DELAY        ORACLE_ESP32_CONFIG_DELAY
#define ORACLE_HCSR04_SPEED_OF_SOUND    ORACLE_HCSR04_CONFIG_SPEED_OF_SOUND
...
#define ORACLE_HCSR04_CONFIG_DEFAULT() {\
    ...
    .max_distance = ORACLE_HCSR04_CONFIG_MAX_DISTANCE,\
    .pad0 = 0,\
    .pad1 = 0,\
    .pad2 = 0,\
